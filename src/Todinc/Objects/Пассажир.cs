...
namespace IIS.Todinc
{
    ...
    [View("ПассажирE", new string[] {
            ...
            "МестоНаРейс.Класс as \'Класс\'"}, Hidden=new string[] {
            "КодБрони.Код",
            "МестоНаРейс.Место"})]
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Todinc.КодБрони fКодБрони;
        
        private IIS.Todinc.МестоНаРейс fМестоНаРейс;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Todinc.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Todinc.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Todinc.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Todinc.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Todinc.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Todinc.Пассажир));
                }
            }
        }
    }
